    ...
    <div class="flex flex-col items-center justify-center min-h-screen px-4">
        ...
        <section class="bg-white/80 dark:bg-gray-900/80 p-8 rounded-xl shadow-lg w-full max-w-md text-center" aria-labelledby="register-page-heading">
            ...
            <header class="text-center">
                <x-header-h1 id="register-page-heading" class="text-4xl font-bold mb-4 font-heading text-black dark:text-white" tabindex="0" aria-label="Registratiepagina voor Natuur Quest">
                    Registreren
                </x-header-h1>
